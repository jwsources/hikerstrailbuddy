...
/*config.sfdc = {
  ...
  auth : {
   ...
   // domain : 'https://login.salesforce.com',
    // For sandbox and scratch orgs use
    ...
    //callbackUrl : 'https://*heroku app domain* /auth/callback',
    ...
    //consumerKey : 'Really long key',
    //consumerSecret : 'The secret, not as long as the consumer key',
  },
